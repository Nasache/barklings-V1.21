...
public class DwellerModel extends SinglePartEntityModel<DwellerEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData rarm = arms.addChild("rarm", ModelPartBuilder.create().uv(0, 18).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-6.0F, -10.0F, 0.0F));

        ModelPartData larm = arms.addChild("larm", ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(6.0F, -10.0F, 0.0F));
