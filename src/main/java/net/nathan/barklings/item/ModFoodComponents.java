...
public class ModFoodComponents {
    ...
    public static final FoodComponent PEAR = new FoodComponent.Builder().nutrition(4).saturationModifier(0.4F).build();
    public static final FoodComponent PLUM = new FoodComponent.Builder().nutrition(2).saturationModifier(0.4F).build();
