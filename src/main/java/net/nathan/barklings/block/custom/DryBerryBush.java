...
public class DryBerryBush extends PlantBlock implements Fertilizable {
    ...
    public DryBerryBush(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.DRY_BERRIES);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.DRY_BERRIES, j + (bl ? 1 : 0)));
