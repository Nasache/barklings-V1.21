...
public class WarpedMangoPod extends PlantBlock implements Fertilizable {
    ...
    public WarpedMangoPod(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.WARPED_MANGO);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.WARPED_MANGO, j + (bl ? 1 : 0)));
