...
public class DuskBerryBush extends PlantBlock implements Fertilizable {
    ...
    public DuskBerryBush(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.DUSK_BERRY);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.DUSK_BERRY, j + (bl ? 1 : 0)));
